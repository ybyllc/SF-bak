...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_SDA_Pin|OLED_SCL_Pin|F_L_2IN_Pin|F_R_2IN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin */
  GPIO_InitStruct.Pin = OLED_PUSH_Pin|OLED_TR_A_Pin|OLED_TR_B_Pin|D1_433_Pin
                          |D0_433_Pin;
